...
<h3>Donation ID : <?php echo $donation['id'] ?> - <?php echo $donation['amount'] ?> Rs</h3>
...
<table>
	...
	<tr><td>Fundraiser</td><td><a href="user.php?action=edit&id=<?php echo $donation['fundraiser_user_id'] ?>"><?php echo $donation['fundraiser'] . '/' . $donation['fundraiser_email'] ?></a></td></tr>
